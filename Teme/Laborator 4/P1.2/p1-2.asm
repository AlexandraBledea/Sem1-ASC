...
start:
    ...
    mov EBX, 0
    mov AL, [b] ; we pute the value of b in AL
    ...
    and EAX, 0000 0000 0000 0000 0000 0000 0111 1000 b ; EAX = 0000 0000 0000 0000 0000 0000 0101 0000 ; we isolate from b the bits 0-3
    ...
    or EBX, 1111 1111 1111 1111 0000 0110 0000 1010 b ; we make the bits from the positions 4-7 to have the value 0, from 8-10 to have the value 110 and from 16-31 to have the value 1
    
    mov AL, [a] ; we pute the value of a in AL
    mov AH, 0 ; we convert it in AX
    mov DX, 0 ; we convert it in DX:AX
    
    push DX
    push AX
    push EAX ; we put in EAX the value of a
    
    and EAX, 0000 0000 0000 0000 0000 0000 0001 1111 b ; EAX = 0000 0000 0000 0000 0000 0000 0001 1011 ; we isolate from a the bits 0-4
